...
use App\Models\PermissionRequestModel; // Import PermissionRequestModel
...
class Dashboard extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'grafikKehadiranGuru' => $guruKehadiranArray,
    ...
    {
        // Logika untuk halaman permintaan izin
        return view('admin/permission_requests'); // Pastikan view ini ada
    }
}
