                ...
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <?= $generalSettings->school_name ?? 'Sekolah'; ?>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-3">
                                ...
                                <h3><?= $jumlahKehadiranSiswa['hadir'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-warning"><b>Sakit</b></h4>
                                <h3><?= $jumlahKehadiranSiswa['sakit'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-info"><b>Izin</b></h4>
                                <h3><?= $jumlahKehadiranSiswa['izin'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-danger"><b>Alfa</b></h4>
                                <h3><?= $jumlahKehadiranSiswa['alfa'] ?? 0; ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-3">
                                <h4 class="text-success"><b>Hadir</b></h4>
                                <h3><?= $jumlahKehadiranGuru['hadir'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-warning"><b>Sakit</b></h4>
                                <h3><?= $jumlahKehadiranGuru['sakit'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-info"><b>Izin</b></h4>
                                <h3><?= $jumlahKehadiranGuru['izin'] ?? 0; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-danger"><b>Alfa</b></h4>
                                <h3><?= $jumlahKehadiranGuru['alfa'] ?? 0; ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function initDashboardPageCharts() {
        if ($('#kehadiranSiswa').length) {
            /* ----------==========     Chart tingkat kehadiran siswa    ==========---------- */
            const dataKehadiranSiswa = [<?php echo implode(',', $grafikKehadiranSiswa ?? []); ?>];
            const labels = [<?php echo "'" . implode("','", $dateRange ?? []) . "'"; ?>];
            ...
            var highestData = Math.max(...dataKehadiranSiswa);
        ...
        if ($('#kehadiranGuru').length) {
            /* ----------==========     Chart tingkat kehadiran guru    ==========---------- */
            const dataKehadiranGuru = [<?php echo implode(',', $grafikKehadiranGuru ?? []); ?>];
            const labels = [<?php echo "'" . implode("','", $dateRange ?? []) . "'"; ?>];
            ...
            var highestData = Math.max(...dataKehadiranGuru);
